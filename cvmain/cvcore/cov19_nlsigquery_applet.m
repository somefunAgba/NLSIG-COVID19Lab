function [app,time_data,gbest_fitstats,ymets,xmets,new_mts] = ...
    cov19_nlsigquery_applet(country_code,update,focus,nboot,boots,finer,app)

% [gsol,gbest_fitstats,ymets,xmets,new_mts]
...
[t,y,dy,status,ccs] = getcasesbycc_applet(app,country_code,update,focus); %#ok<ASGLU>
...
[gy_sollb,gdy_sollb,gsol_lb,gy_solub,gdy_solub,gsol_ub,...
    gbest_fitstatslb,gbest_fitstatsub] ...
    = nsligfp_dkw_applet(app,x_data,y_data,dy_data,gsol,gy_sol,gdy_sol,len_sol,...
    imposeconstr,chngsolver,gbest_fitstats,...
    gy_mdlfun,gdy_dx_mdlfun,gnlsigprob,gx0,gn_ips,gnewoptins); %#ok<ASGLU>
end
...
%     end
    ...
    if boots == true
        ...
        [y_sollb,dy_sollb,sol_lb,y_solub,dy_solub,sol_ub,...
            best_fitstatslb,best_fitstatsub] ...
            = nsligfp_dkw_applet(app,x_data,sy_data,sdy_data,sol,y_sol,dy_sol,len_sol,...
            imposeconstr,chngsolver,gbest_fitstats,...
            y_mdlfun,dy_dx_mdlfun,nlsigprob,x0,n_ips,gnewoptins); %#ok<ASGLU>
